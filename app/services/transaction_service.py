...
class TransactionService:
    ...
    async def create_internal_transfer(
        self, transaction_data: TransactionCreate, org_id: uuid.UUID
    ) -> Transaction:
        """
        ...
        try:
            ...
            sender_wallet = await self.wallet_service.get_wallet_by_id(
                uuid.UUID(transaction_data.sender_wallet_id), org_id
            )
            receiver_wallet = await self.wallet_service.get_wallet_by_id(
                uuid.UUID(transaction_data.receiver_wallet_id), org_id
            )
    ...
    async def get_transaction_by_id(
        self, transaction_id: uuid.UUID, org_id: uuid.UUID
    ...
    async def get_transactions(
        self, org_id: uuid.UUID, filters: TransactionFilter
